...
namespace PfeProject.Migrations
{
    ...
    [Migration("20241209225139_JsonItem")]
    partial class JsonItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "b8ad4327-909b-4727-a6b4-99194eafe334",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "8247d970-c0bf-4705-851c-b6a34d508e14",
                            Name = "HR",
                            NormalizedName = "HR"
                        },
                        new
                        {
                            Id = "f74dcd53-d0de-4fba-a13f-24e7ea7058ee",
                            Name = "Employee",
            ...
            modelBuilder.Entity("PfeProject.Models.FormSubmission", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PfeProject.Models.FormSubmission", b =>
                {
                    ...
                    b.HasOne("PfeProject.Models.FormConfiguration", "Form")
                        .WithMany()
                        .HasForeignKey("FormId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PfeProject.Models.User", "User")
